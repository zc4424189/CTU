...
{
	BYTE ByteFrmType ;    //帧类型 三种 U /I /S
	BYTE ByteTranType ;   //传输类型  对应STI104 MTI104 和U格式的6种类型
	short ByteTranCot ;    //传输原因  对应COT104
	short ByteRevS ;       //接收序号
	short ByteSendS ;      //发送序号
	BYTE  ByteVar   ;      //保留，做结构对齐用的
	BYTE  ByteSQNum ;      //可变结构限定词
    short  ByteAPDUaddr ;   //APDU地址
    BYTE* pinfo   ;      //信息体信息
